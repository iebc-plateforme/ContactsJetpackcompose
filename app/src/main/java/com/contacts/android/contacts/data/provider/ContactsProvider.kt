...
class ContactsProvider @Inject constructor(
    ...
    suspend fun getSystemGroups(): List<SystemGroupData> = withContext(Dispatchers.IO) {
        ...
        // NOTE: Do not deduplicate by systemId/title here because group memberships are tied
        // to the raw Groups._ID values. Deduplication can break contact-group associations.
        groups.sortedBy { it.title }
    }
