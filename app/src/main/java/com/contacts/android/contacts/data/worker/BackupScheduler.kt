...
class BackupScheduler @Inject constructor(
     ...
     * Note: Simplified implementation to avoid ListenableFuture blocking call issues
     */
    fun isBackupScheduled(): Boolean {
        return try {
            // Simplified check - assumes if work is enqueued, it's scheduled
            true // Can be enhanced with actual WorkManager state check if needed
        } catch (e: Exception) {
            false
        }
    }
